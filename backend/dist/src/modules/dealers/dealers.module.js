...
const dealers_controller_1 = require("./Controllers/dealers.controller");
...
exports.DealersModule = DealersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [dealer_services_1.DealersService, prisma_service_1.PrismaService],
        exports: [dealer_services_1.DealersService],
    })
], DealersModule);
